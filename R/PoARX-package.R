#' @title Fit PoARX models to multivariate time series
#'
#' @description PoARX models for multivariate time series. The time series can
#'    be independent, or modelled with a dependency using Frank’s Copula.
#'
#' @details
...
#' @importFrom copula frankCopula pCopula psi iPsi
#' @importFrom lubridate dmy
#' @importFrom MASS mvrnorm
#' @importFrom Matrix nearPD bdiag
#' @importFrom numDeriv grad hessian
#' @importFrom Rdpack reprompt
#' @importFrom stats AIC coef logLik nobs residuals var vcov
#' @importFrom stats constrOptim cov dpois model.matrix optim ppois pt quantile
